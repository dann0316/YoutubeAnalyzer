...
const SignUp = () => {
    ...
    return (
        <main className="w-full min-h-screen p-24">
            <div className="flex flex-col justify-center items-center border border-primary rounded-3xl p-5 gap-10">
                <h3 className="text-2xl font-bold text-black">Sign Up</h3>

                <form className="w-1/3 flex flex-col justify-center items-center gap-7" onSubmit={handleSubmit(onSignUpSubmit)}>
                    {/* 이메일 section */}
                ...
                <div className="text-sm text-[#7d7d7d]">
                    * Youlytics 이용약관, 개인정보 수집 안내를 확인하고,
                    동의합니다.
                </div>
            </div>
        </main>
